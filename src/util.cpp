...
const char * const BITCOIN_CONF_FILENAME = "viz.conf";
const char * const BITCOIN_PID_FILENAME = "viz.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Viz";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Viz";
#else
    // Unix
    return pathRet / ".viz";
#endif
