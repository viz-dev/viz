...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s viz-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  viz-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded viz transaction") + "\n" +
              "  viz-tx [options] -create [commands]   " + _("Create hex-encoded viz transaction") + "\n" +
              "\n";
